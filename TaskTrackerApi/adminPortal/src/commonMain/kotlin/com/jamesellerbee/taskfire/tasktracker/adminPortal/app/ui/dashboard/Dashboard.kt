package com.jamesellerbee.taskfire.tasktracker.adminPortal.app.ui.dashboard
...
fun Dashboard(serviceLocator: ServiceLocator, modifier: Modifier = Modifier) {
    val viewModel = remember { DashboardViewModel(serviceLocator) }
...
@Composable
fun AccountsHeader(viewModel: DashboardViewModel, modifier: Modifier = Modifier) {
...
@Composable
fun AccountDialog(viewModel: DashboardViewModel, selectedAccount: Account, onDismiss: () -> Unit) {
